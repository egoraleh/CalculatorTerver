...
@WebServlet("/razm-bez-povt")
public class RazmBezPovtServlet extends HttpServlet {
    @Override
    public void doGet(HttpServletRequest req, HttpServletResponse resp) {
        ...
        try {
            FreemarkerHelper.drawPage(req, resp, "razmbezpovt.ftl", content);
    ...
    public void doPost(HttpServletRequest req, HttpServletResponse resp) {
        ...
        BigInteger ans = FactorialHelper.factorial(n).divide(FactorialHelper.factorial(n - k));
